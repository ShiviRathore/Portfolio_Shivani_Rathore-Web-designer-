                    ...
                    <div className='flex flex-col md:flex-row items-center justify-center gap-5'>
                        ...
                        <div className='md:w-1/2 w-full'>                        
                            ...
                            <p className="xs:text-sm text-xs leading-relaxed text-gray-300 text-left" data-aos="fade-left">
                                Hello I am <span className="font-semibold text-[#0488CC]">Shivani Rathore, </span>a passionate Web Designer & UI/UX Designer with over 2+ years of experience crafting responsive websites and intuitive digital experiences. I excel at creating pixel-perfect interfaces that are both visually stunning and highly functional. 
                                <br className="mt-2" />
                                <strong className="text-gray-200">Web Design Skills:</strong> HTML, CSS, Sass/SCSS, JavaScript, Bootstrap, jQuery, React, Tailwind CSS.
                                <br />
                                <strong className="text-gray-200">UI/UX Design Skills:</strong> Figma (Prototyping, Auto Layout, Wireframing), User Research, Information Architecture, and Interaction Design.
                                <br className="mt-2" />
                                My design philosophy combines clean aesthetics with user-centered functionality. I transform complex ideas into engaging web experiences that perform seamlessly across all devices.
                            </p>
